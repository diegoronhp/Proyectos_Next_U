...
//FUNCION PARA OBTENER Y MOSTRAR LOS REGISTROS DE LA BASE DE DATOS
    obtenerDataInicial() {
 ...
 //FUNCION PARA POBLAR EL CALENDARIO CON LOS REGISTROS DE EVENTOS
    ...
    //FUNCION PARA AÑADIR UN NUEVO EVENTO A LA BASE DE DATOS
    anadirEvento(){
      var horaInicial = "12:00:00";
      var horaFinal = "11:59:00";
      ...
      if (!document.getElementById('allDay').checked) {
        ...
        form_data.append('diaCompleto', 0)
      }else {
        form_data.append('end_date', $('#start_date').val())
        form_data.append('end_hour', horaFinal)
        form_data.append('start_hour', horaInicial)
        form_data.append('diaCompleto', 1)
      }
      $.ajax({
        ...
        error: function(){
          alert("error en la comunicación con el servidor - controlador");
        }
      })

    }

//FUNCION PARA ELIMINAR UN REGISTRO DE EVENTO EN LA BASE DE DATOS
...
//FUNCION PARA ACTUALIZAR UN REGISTRO DE EVENTO EN LA BASE DE DATOS
